...
<?php get_header(); ?>
    ...
    <section id="demoPage">
        ...
        <div class="content">
            <h2 class="uppercase">Get a demo</h2>
            <form action="" id="getDemo">
                ...
                <div class="successMessage" style="display: none;">Excellent. Our manager will contact you soon.</div>
                <div id="errorMessage" style="display: none;">One or more fields are not filled in correctly.</div>
            </form>
        </div>
